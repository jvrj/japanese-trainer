...
- **Phase 0.6 · Feedback soul + conversation feel** — corrective-feedback layer (confirm/recast/clarify), 90s patient mic, honest keyless demo, modules-as-data-rows, anti-robotic set; forge stages F1–F5. → **spec + forge brief: `docs/delve-cycles/7-feedback-soul.md` §8** (Delve 7, round 1 synthesized; ADR-011 pending).
