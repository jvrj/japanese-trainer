...
- **Vocab hard-lock vs coverage meter deep-dive** — owner leans toward locking ("more controlled") but wants it studied before deciding; ADR-003 stays pending, meter stays shipped meanwhile. Owner call 2026-07-19.
