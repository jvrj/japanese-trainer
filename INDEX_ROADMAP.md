...
- **Phase 0.6 · Feedback soul + conversation feel** — corrective-feedback layer (confirm/recast/clarify), honest keyless demo, modules-as-data-rows, anti-robotic set; forge stages F3–F5 remain (**F1 patient mic SHIPPED v8.16 · F2 feedback layer SHIPPED v8.17, 2026-07-18** — owner keyed session next doubles as the F1+F2 calibration; then F3 honest modes). → **spec + forge brief: `docs/delve-cycles/7-feedback-soul.md` §8** (Delve 7, round 1 synthesized; ADR-011 pending).
